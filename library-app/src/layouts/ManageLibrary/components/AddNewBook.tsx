                    ...
                    <form action="" method="POST">
                        <div className="row">
                            <div className="col-md-6 mb-3">
                                ...
                                <input type="text" className="form-control" name="title" required
                                    onChange={e => {setTitle(e.target.value);console.log(title)}} value={title} />
                            </div>
                            <div className="col-md-3 mb-3">
                                <label className="form-label">Author</label>
                                <input type="text" className="form-control" name="author" required
                                    onChange={e => {setAuthor(e.target.value);console.log(author)}} value={author} />
                            </div>
                            <div className="col-md-3 mb-3">
                                <label className="form-label">Category</label>
                                <button className="form-control btn btsecondary dropdown-toggle" type="button"
                        ...
                        <div className="col-md-12 mb-3">
                            ...
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows={3}
                                onChange={e => {setDescription(e.target.value);console.log(description)}} value={description}></textarea>
                        </div>      
                        <div className="col-md-3 mb-3">
                            <label className="form-label">Copies</label>
                            <input type="number" className="form-control" name="copies" required
                                onChange={e => {setCopies(Number(e.target.value)); console.log(copies)}} value={copies} />
                        </div>
                        <input type="file" onChange={e => {base64ConversionForImages(e);console.log(base64ConversionForImages)}} />
                        <div>
